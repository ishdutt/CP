...
*/
void dijikstra(vector<pair<int,int>>graph[],int n,vector<bool>&visited,int source,int destination)
{   
    ...
    //     cout<<i<<" "<<dis[i]<<endl;
    // }
    int finaldes=destination++;
    //cout<<"TEST="<<finaldes<<endl;
    if(dis[finaldes]==INT_MAX)	cout<<"NO"<<endl;
    
    else
    cout<<dis[finaldes]<<endl;
}
